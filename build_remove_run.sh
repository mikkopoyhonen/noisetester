...
sudo docker run -i -t -d -e "NOISEPORT=8002" -p 8001:8001 -p 8002:8002 --privileged --name contriboard-noise temetz/contriboard-noise
echo "Remember to set your API_URL and IO_URL enviroment variables"
echo "Run: sh enviroment_variables.sh for easy copy-paste string of variables"
